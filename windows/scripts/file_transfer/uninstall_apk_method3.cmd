...
set filemode=UNINSTALL [Method: %adb% shell pm uninstall]
...
echo.
echo.
echo YOU MUST RESTART THE PHONE FOR THE APP LIST TO REFRESH!!
echo.
echo THIS WILL BE FIXED SOON!! I PROMISE!!
echo.
echo.
echo TO REBOOT THE PHONE MANUALLY TYPE "Z" AND PRESS ENTER
echo.
echo.
echo.
%cocolor% 0b
