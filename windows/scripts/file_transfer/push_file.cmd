...
echo.
echo.
echo Type or drag source file or directory on computer and Press ENTER:
echo.
echo.
...
echo.
echo.
echo Type destination file or directory on device and Press ENTER:
echo.
echo.
...
:execute
%adb% push %sourcefile% %destinationfile%
