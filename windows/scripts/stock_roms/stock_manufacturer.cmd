...
if %action%==1 %browser% "%dl_server%/bin/roms/stock/acer/"

if %action%==2 %browser% "%dl_server%/bin/roms/stock/amazon/"

if %action%==3 %browser% "%dl_server%/bin/roms/stock/asus/"

if %action%==4 %browser% "%dl_server%/bin/roms/stock/dell/"

if %action%==5 %browser% "%dl_server%/bin/roms/stock/foxconn/"

if %action%==6 %browser% "%dl_server%/bin/roms/stock/google/"

if %action%==7 %browser% "%dl_server%/bin/roms/stock/hisense/"

if %action%==8 %browser% "%dl_server%/bin/roms/stock/hp/"

if %action%==9 %browser% "%dl_server%/bin/roms/stock/htc/"

if %action%==10 %browser% "%dl_server%/bin/roms/stock/kyocera/"

if %action%==11 %browser% "%dl_server%/bin/roms/stock/lg/"

if %action%==12 %browser% "%dl_server%/bin/roms/stock/motorola/"
...
if %action%==13 %browser% "%dl_server%/bin/roms/stock/pegatron/"

if %action%==14 %browser% "%dl_server%/bin/roms/stock/samsung/"

if %action%==15 %browser% "%dl_server%/bin/roms/stock/sony/"

if %action%==16 %browser% "%dl_server%/bin/roms/stock/teleepoch/"

if %action%==17 %browser% "%dl_server%/bin/roms/stock/zte/"
