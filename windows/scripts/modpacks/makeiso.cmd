...
%mkisofs% -o "%dl_path%\modpacks\%ro_product_manufacturer%\%ro_product_model%\modpack_%ro_product_model%_%ro_product_board%.iso" -J -R -r "%dl_temp%\modpacks\%ro_product_manufacturer%\%ro_product_model%"
