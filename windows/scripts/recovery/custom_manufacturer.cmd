...
if %action%==1 %browser% "%dl_server%/bin/recovery/images/custom/acer/"

if %action%==2 %browser% "%dl_server%/bin/recovery/images/custom/amazon/"

if %action%==3 %browser% "%dl_server%/bin/recovery/images/custom/asus/"

if %action%==4 %browser% "%dl_server%/bin/recovery/images/custom/dell/"

if %action%==5 %browser% "%dl_server%/bin/recovery/images/custom/foxconn/"

if %action%==6 %browser% "%dl_server%/bin/recovery/images/custom/google/"

if %action%==7 %browser% "%dl_server%/bin/recovery/images/custom/hisense/"

if %action%==8 %browser% "%dl_server%/bin/recovery/images/custom/hp/"

if %action%==9 %browser% "%dl_server%/bin/recovery/images/custom/htc/"

if %action%==10 %browser% "%dl_server%/bin/recovery/images/custom/kyocera/"

if %action%==11 %browser% "%dl_server%/bin/recovery/images/custom/lg/"

if %action%==12 %browser% "%dl_server%/bin/recovery/images/custom/motorola/"
...
if %action%==13 %browser% "%dl_server%/bin/recovery/images/custom/pegatron/"

if %action%==14 %browser% "%dl_server%/bin/recovery/images/custom/samsung/"

if %action%==15 %browser% "%dl_server%/bin/recovery/images/custom/sony/"

if %action%==16 %browser% "%dl_server%/bin/recovery/images/custom/teleepoch/"

if %action%==17 %browser% "%dl_server%/bin/recovery/images/custom/zte/"
