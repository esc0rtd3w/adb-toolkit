...
if %action%==1 start %browser% "%dl_server%/roms/custom/acer/"

if %action%==2 start %browser% "%dl_server%/roms/custom/amazon/"

if %action%==3 start %browser% "%dl_server%/roms/custom/asus/"

if %action%==4 start %browser% "%dl_server%/roms/custom/dell/"

if %action%==5 start %browser% "%dl_server%/roms/custom/foxconn/"

if %action%==6 start %browser% "%dl_server%/roms/custom/google/"

if %action%==7 start %browser% "%dl_server%/roms/custom/hisense/"

if %action%==8 start %browser% "%dl_server%/roms/custom/hp/"

if %action%==9 start %browser% "%dl_server%/roms/custom/htc/"

if %action%==10 start %browser% "%dl_server%/roms/custom/kyocera/"

if %action%==11 start %browser% "%dl_server%/roms/custom/lg/"

if %action%==12 start %browser% "%dl_server%/roms/custom/motorola/"
...
if %action%==13 start %browser% "%dl_server%/roms/custom/pegatron/"

if %action%==14 start %browser% "%dl_server%/roms/custom/samsung/"

if %action%==15 start %browser% "%dl_server%/roms/custom/sony/"

if %action%==16 start %browser% "%dl_server%/roms/custom/teleepoch/"

if %action%==17 start %browser% "%dl_server%/roms/custom/zte/"
