...
echo.
echo.
echo 1) gapps-mdpi-20110501-signed.zip (Most Popular)
echo.
echo 2) gapps-mdpi-20110301-signed.zip
echo.
echo 3) gapps-mdpi-20101020-signed.zip
echo.
echo 4) gapps-mdpi-20100930-signed.zip
echo.
echo 5) gapps-mdpi-20100816-signed.zip
echo.
echo.
%cocolor% 0b
...
:opt1
set zipname=gapps-mdpi-20110501-signed.zip
goto dlnow


:opt2
set zipname=gapps-mdpi-20110301-signed.zip
goto dlnow


:opt3
set zipname=gapps-mdpi-20101020-signed.zip
goto dlnow


:opt4
set zipname=gapps-mdpi-20100930-signed.zip
goto dlnow


:opt5
set zipname=gapps-mdpi-20100816-signed.zip
goto dlnow
